...
return {
    ...
    TRAFFIC_FRICTION,
    TRAFFIC_SAFE_DISTANCE,
    TRAFFIC_STOP_DISTANCE,
    TRAFFIC_CAR_COUNT,
    ...
    HEALTH_MAX,
    DAMAGE_PER_COLLISION,
    DAMAGE_SPEED_FACTOR,
    HEALTH_WARNING_LEVEL,
    HEALTH_CRITICAL_LEVEL,
    ...
    DELIVERY_TIME_BONUS,
    TIMETRIAL_BASE_REWARD,
    TIMETRIAL_CHECKPOINT_BONUS,
